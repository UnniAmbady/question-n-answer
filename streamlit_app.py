...
if st.checkbox("Agile Approach"):
    ...
    st.warning("This software is under development using Agile Approach. Development will be done in stages. The model answer will be shown only after grading; in future veriosns")
